...
// ===== Double-output helper (SAFE) =====
// 1성 정수 / 2성 에센스는 제작 1회당 2개 생산
function isDoubleOutput(name){
  return (
    name.includes("정수 ★") ||
    name.includes("에센스 ★★")
  );
...
// NOTE: produced accumulation pattern not auto-matched. Please replace produced[name] += y[i]; with multiplier.
