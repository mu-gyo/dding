...
// A안 (1★/2★ yield=2, 3★ yield=1)
// ================================
const RECIPES = {
  // 1성
  "수호의 정수 ★": { yield: 2, ing: { "굴 ★": 2, "점토": 1 } },
  "파동의 정수 ★": { yield: 2, ing: { "소라 ★": 2, "모래": 3 } },
  "혼란의 정수 ★": { yield: 2, ing: { "문어 ★": 2, "흙": 4 } },
  "생명의 정수 ★": { yield: 2, ing: { "미역 ★": 2, "자갈": 2 } },
  "부식의 정수 ★": { yield: 2, ing: { "성게 ★": 2, "화강암": 1 } },

  "물결 수호의 핵 ★": { yield: 1, ing: { "수호의 정수 ★": 1, "파동의 정수 ★": 1, "익히지 않은 새우": 1 } },
  "파동 오염의 핵 ★": { yield: 1, ing: { "파동의 정수 ★": 1, "혼란의 정수 ★": 1, "익히지 않은 도미": 1 } },
  "질서 파괴의 핵 ★": { yield: 1, ing: { "혼란의 정수 ★": 1, "생명의 정수 ★": 1, "익히지 않은 청어": 1 } },
  "활력 붕괴의 핵 ★": { yield: 1, ing: { "생명의 정수 ★": 1, "부식의 정수 ★": 1, "금붕어": 1 } },
  "침식 방어의 핵 ★": { yield: 1, ing: { "부식의 정수 ★": 1, "수호의 정수 ★": 1, "농어": 1 } },

  "영생의 아쿠티스 ★": { yield: 1, ing: { "물결 수호의 핵 ★": 1, "질서 파괴의 핵 ★": 1, "활력 붕괴의 핵 ★": 1 } },
  "크라켄의 광란체 ★": { yield: 1, ing: { "질서 파괴의 핵 ★": 1, "활력 붕괴의 핵 ★": 1, "파동 오염의 핵 ★": 1 } },
  "리바이던의 깃털 ★": { yield: 1, ing: { "침식 방어의 핵 ★": 1, "파동 오염의 핵 ★": 1, "물결 수호의 핵 ★": 1 } },

  // 2성
  "수호 에센스 ★★": { yield: 2, ing: { "굴 ★★": 2, "해초": 2, "네더랙": 8 } },
  "파동 에센스 ★★": { yield: 2, ing: { "소라 ★★": 2, "해초": 2, "마그마 블록": 4 } },
  "혼란 에센스 ★★": { yield: 2, ing: { "문어 ★★": 2, "해초": 2, "영혼 흙": 4 } },
  "생명 에센스 ★★": { yield: 2, ing: { "미역 ★★": 2, "해초": 2, "진홍빛 자루": 2 } },
  "부식 에센스 ★★": { yield: 2, ing: { "성게 ★★": 2, "해초": 2, "뒤틀린 자루": 2 } },

  "활기 보존의 결정 ★★": { yield: 1, ing: { "수호 에센스 ★★": 1, "생명 에센스 ★★": 1, "켈프": 3, "청금석 블록": 1 } },
  "파도 침식의 결정 ★★": { yield: 1, ing: { "파동 에센스 ★★": 1, "부식 에센스 ★★": 1, "켈프": 3, "레드스톤 블록": 1 } },
  "방어 오염의 결정 ★★": { yield: 1, ing: { "혼란 에센스 ★★": 1, "수호 에센스 ★★": 1, "켈프": 3, "철 주괴": 1 } },
  "격류 재생의 결정 ★★": { yield: 1, ing: { "생명 에센스 ★★": 1, "파동 에센스 ★★": 1, "켈프": 3, "금 주괴": 1 } },
  "맹독 혼란의 결정 ★★": { yield: 1, ing: { "부식 에센스 ★★": 1, "혼란 에센스 ★★": 1, "켈프": 3, "다이아몬드": 1 } },

  "해구 파동의 코어 ★★": { yield: 1, ing: { "활기 보존의 결정 ★★": 1, "파도 침식의 결정 ★★": 1, "격류 재생의 결정 ★★": 1 } },
  "침묵의 심해 비약 ★★": { yield: 1, ing: { "파도 침식의 결정 ★★": 1, "격류 재생의 결정 ★★": 1, "맹독 혼란의 결정 ★★": 1 } },
  "청해룡의 날개 ★★": { yield: 1, ing: { "방어 오염의 결정 ★★": 1, "맹독 혼란의 결정 ★★": 1, "활기 보존의 결정 ★★": 1 } },

  // 3성
  "수호의 엘릭서 ★★★": { yield: 1, ing: { "굴 ★★★": 1, "불우렁쉥이": 1, "유리병": 3, "엔드 돌": 1 } },
  "파동의 엘릭서 ★★★": { yield: 1, ing: { "소라 ★★★": 1, "불우렁쉥이": 1, "유리병": 3, "엔드 석재 벽돌": 1 } },
  "혼란의 엘릭서 ★★★": { yield: 1, ing: { "문어 ★★★": 1, "불우렁쉥이": 1, "유리병": 3, "후렴과": 4 } },
  "생명의 엘릭서 ★★★": { yield: 1, ing: { "미역 ★★★": 1, "불우렁쉥이": 1, "유리병": 3, "튀긴 후렴과": 4 } },
  "부식의 엘릭서 ★★★": { yield: 1, ing: { "성게 ★★★": 1, "불우렁쉥이": 1, "유리병": 3, "퍼퍼 블록": 1 } },

  "불멸 재생의 영약 ★★★": { yield: 1, ing: { "수호의 엘릭서 ★★★": 1, "생명의 엘릭서 ★★★": 1, "말린 켈프": 5, "발광 열매": 2, "죽은 관 산호 블록": 1 } },
  "파동 장벽의 영약 ★★★": { yield: 1, ing: { "파동의 엘릭서 ★★★": 1, "수호의 엘릭서 ★★★": 1, "말린 켈프": 5, "발광 열매": 2, "죽은 사방산호 블록": 1 } },
  "타락 침식의 영약 ★★★": { yield: 1, ing: { "혼란의 엘릭서 ★★★": 1, "부식의 엘릭서 ★★★": 1, "말린 켈프": 5, "발광 열매": 2, "죽은 거품 산호 블록": 1 } },
  "생명 광란의 영약 ★★★": { yield: 1, ing: { "생명의 엘릭서 ★★★": 1, "혼란의 엘릭서 ★★★": 1, "말린 켈프": 5, "발광 열매": 2, "죽은 불 산호 블록": 1 } },
  "맹독 파동의 영약 ★★★": { yield: 1, ing: { "부식의 엘릭서 ★★★": 1, "파동의 엘릭서 ★★★": 1, "말린 켈프": 5, "발광 열매": 2, "죽은 뇌 산호 블록": 1 } },

  "아쿠아 펄스 파편 ★★★": { yield: 1, ing: { "불멸 재생의 영약 ★★★": 1, "파동 장벽의 영약 ★★★": 1, "맹독 파동의 영약 ★★★": 1 } },
  "나우틸러스의 손 ★★★": { yield: 1, ing: { "파동 장벽의 영약 ★★★": 1, "생명 광란의 영약 ★★★": 1, "불멸 재생의 영약 ★★★": 1 } },
  "무저의 척추 ★★★": { yield: 1, ing: { "타락 침식의 영약 ★★★": 1, "맹독 파동의 영약 ★★★": 1, "생명 광란의 영약 ★★★": 1 } }
};

function recipeYield(name){ return RECIPES[name]?.yield || 1; }
function recipeIng(name){ return RECIPES[name]?.ing || {}; }

// UI helper to show ×yield
function displayNameWithYield(name){
  const y = recipeYield(name);
  return y>1 ? `${name} ×${y}` : name;
}
...
{ name:"영생의 아쿠티스 ★", base:3780 },
  ...
  { name:"리바이던의 깃털 ★", base:3951 },
  { name:"해구 파동의 코어 ★★", base:8154 },
  { name:"침묵의 심해 비약 ★★", base:8236 },
  { name:"청해룡의 날개 ★★", base:8351 },
  { name:"아쿠아 펄스 파편 ★★★", base:13909 },
  { name:"나우틸러스의 손 ★★★", base:14071 },
  { name:"무저의 척추 ★★★", base:14160 },
];
